...
entry:
  ...
  %statepoint_token80 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @bottom_up_tree, i32 1, i32 0, i64 %to_i648, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %stretchDepth_live, ptr addrspace(1) %maxDepth_live) ]
  %call81 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token80)
  %stretchDepth_live.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token80, i32 0, i32 0) ; (%stretchDepth_live, %stretchDepth_live)
  %maxDepth_live.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token80, i32 1, i32 1) ; (%maxDepth_live, %maxDepth_live)
  store ptr addrspace(1) %maxDepth_live.relocated, ptr %maxDepth, align 8
  store ptr addrspace(1) %stretchDepth_live.relocated, ptr %stretchDepth, align 8
  %to_gcptr9 = inttoptr i64 %call81 to ptr addrspace(1)
  %to_i6410 = ptrtoint ptr addrspace(1) %to_gcptr9 to i64
  %maxDepth_live11 = load ptr addrspace(1), ptr %maxDepth, align 8
  %stretchDepth_live12 = load ptr addrspace(1), ptr %stretchDepth, align 8
  %statepoint_token82 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @item_check, i32 1, i32 0, i64 %to_i6410, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %stretchDepth_live12, ptr addrspace(1) %maxDepth_live11) ]
  %call1383 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token82)
  %stretchDepth_live12.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token82, i32 0, i32 0) ; (%stretchDepth_live12, %stretchDepth_live12)
  %maxDepth_live11.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token82, i32 1, i32 1) ; (%maxDepth_live11, %maxDepth_live11)
  store ptr addrspace(1) %maxDepth_live11.relocated, ptr %maxDepth, align 8
  store ptr addrspace(1) %stretchDepth_live12.relocated, ptr %stretchDepth, align 8
  %to_gcptr14 = inttoptr i64 %call1383 to ptr addrspace(1)
  %to_i6415 = ptrtoint ptr addrspace(1) %to_gcptr14 to i64
  %maxDepth_live16 = load ptr addrspace(1), ptr %maxDepth, align 8
  %stretchDepth_live17 = load ptr addrspace(1), ptr %stretchDepth, align 8
  %statepoint_token84 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(void (i64, i64)) @rt_print_stretch_check, i32 2, i32 0, i64 %to_i646, i64 %to_i6415, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %stretchDepth_live17, ptr addrspace(1) %maxDepth_live16) ]
  %stretchDepth_live17.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token84, i32 0, i32 0) ; (%stretchDepth_live17, %stretchDepth_live17)
  %maxDepth_live16.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token84, i32 1, i32 1) ; (%maxDepth_live16, %maxDepth_live16)
  store ptr addrspace(1) %maxDepth_live16.relocated, ptr %maxDepth, align 8
  store ptr addrspace(1) %stretchDepth_live17.relocated, ptr %stretchDepth, align 8
  %maxDepth18 = load ptr addrspace(1), ptr %maxDepth, align 8
  %to_i6419 = ptrtoint ptr addrspace(1) %maxDepth18 to i64
  %maxDepth_live20 = load ptr addrspace(1), ptr %maxDepth, align 8
  %stretchDepth_live21 = load ptr addrspace(1), ptr %stretchDepth, align 8
  %statepoint_token85 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @bottom_up_tree, i32 1, i32 0, i64 %to_i6419, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %stretchDepth_live21, ptr addrspace(1) %maxDepth_live20) ]
  %call2286 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token85)
  %stretchDepth_live21.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token85, i32 0, i32 0) ; (%stretchDepth_live21, %stretchDepth_live21)
  %maxDepth_live20.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token85, i32 1, i32 1) ; (%maxDepth_live20, %maxDepth_live20)
  ...
  %maxDepth_live26 = load ptr addrspace(1), ptr %maxDepth, align 8
  %stretchDepth_live27 = load ptr addrspace(1), ptr %stretchDepth, align 8
  %longLivedTree_live = load ptr addrspace(1), ptr %longLivedTree, align 8
  %statepoint_token87 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(void (i64)) @rt_set_global_root, i32 1, i32 0, i64 %to_i6425, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %longLivedTree_live, ptr addrspace(1) %stretchDepth_live27, ptr addrspace(1) %maxDepth_live26) ]
  %longLivedTree_live.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token87, i32 0, i32 0) ; (%longLivedTree_live, %longLivedTree_live)
  %stretchDepth_live27.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token87, i32 1, i32 1) ; (%stretchDepth_live27, %stretchDepth_live27)
  %maxDepth_live26.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token87, i32 2, i32 2) ; (%maxDepth_live26, %maxDepth_live26)
...
define i64 @bottom_up_tree(i64 %0) #0 gc "statepoint-example" {
entry:
...
then:                                             ; preds = %entry
  ...
  %depth_live = load ptr addrspace(1), ptr %depth, align 8
  %statepoint_token = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @bottom_up_tree, i32 1, i32 0, i64 %to_i646, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %depth_live) ]
  %call21 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token)
  ...
  store ptr addrspace(1) %depth_live.relocated, ptr %depth, align 8
  %to_gcptr7 = inttoptr i64 %call21 to ptr addrspace(1)
  ...
  %statepoint_token22 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @bottom_up_tree, i32 1, i32 0, i64 %to_i6413, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %to_gcptr7, ptr addrspace(1) %depth_live14) ]
  %call1523 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token22)
  %to_gcptr7.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token22, i32 0, i32 0) ; (%to_gcptr7, %to_gcptr7)
  %depth_live14.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token22, i32 1, i32 1) ; (%depth_live14, %depth_live14)
  store ptr addrspace(1) %depth_live14.relocated, ptr %depth, align 8
  %to_gcptr16 = inttoptr i64 %call1523 to ptr addrspace(1)
  %depth_live17 = load ptr addrspace(1), ptr %depth, align 8
  %statepoint_token24 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(ptr addrspace(1) (ptr addrspace(1), ptr addrspace(1))) @rt_cons_raw_mmtk, i32 2, i32 0, ptr addrspace(1) %to_gcptr7.relocated, ptr addrspace(1) %to_gcptr16, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %depth_live17, ptr addrspace(1) %to_gcptr7.relocated, ptr addrspace(1) %to_gcptr16) ]
  %cons25 = call ptr addrspace(1) @llvm.experimental.gc.result.p1(token %statepoint_token24)
  %depth_live17.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token24, i32 0, i32 0) ; (%depth_live17, %depth_live17)
  %to_gcptr7.relocated26 = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token24, i32 1, i32 1) ; (%to_gcptr7.relocated, %to_gcptr7.relocated)
  %to_gcptr16.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token24, i32 2, i32 2) ; (%to_gcptr16, %to_gcptr16)
  store ptr addrspace(1) %depth_live17.relocated, ptr %depth, align 8
  br label %ifcont

else:                                             ; preds = %entry
  %depth_live18 = load ptr addrspace(1), ptr %depth, align 8
  %statepoint_token27 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(ptr addrspace(1) (ptr addrspace(1), ptr addrspace(1))) @rt_cons_raw_mmtk, i32 2, i32 0, ptr addrspace(1) inttoptr (i64 3 to ptr addrspace(1)), ptr addrspace(1) inttoptr (i64 3 to ptr addrspace(1)), i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %depth_live18) ]
  %cons1928 = call ptr addrspace(1) @llvm.experimental.gc.result.p1(token %statepoint_token27)
  %depth_live18.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token27, i32 0, i32 0) ; (%depth_live18, %depth_live18)
  store ptr addrspace(1) %depth_live18.relocated, ptr %depth, align 8
  br label %ifcont

ifcont:                                           ; preds = %else, %then
  %ifresult = phi ptr addrspace(1) [ %cons25, %then ], [ %cons1928, %else ]
  %to_i6420 = ptrtoint ptr addrspace(1) %ifresult to i64
  ret i64 %to_i6420
}

define i64 @item_check(i64 %0) #0 gc "statepoint-example" {
entry:
  %to_gcptr = inttoptr i64 %0 to ptr addrspace(1)
  ...
  %statepoint_token = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(ptr addrspace(1) (ptr addrspace(1))) @rt_car, i32 1, i32 0, ptr addrspace(1) %node1, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %node_live, ptr addrspace(1) %node1) ]
  %car23 = call ptr addrspace(1) @llvm.experimental.gc.result.p1(token %statepoint_token)
  %node_live.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token, i32 0, i32 0) ; (%node_live, %node_live)
  %node1.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token, i32 1, i32 1) ; (%node1, %node1)
  store ptr addrspace(1) %node_live.relocated, ptr %node, align 8
...
then:                                             ; preds = %entry
  ...
  %statepoint_token24 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(ptr addrspace(1) (ptr addrspace(1))) @rt_car, i32 1, i32 0, ptr addrspace(1) %node3, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %node_live4, ptr addrspace(1) %node3) ]
  %car525 = call ptr addrspace(1) @llvm.experimental.gc.result.p1(token %statepoint_token24)
  %node_live4.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token24, i32 0, i32 0) ; (%node_live4, %node_live4)
  %node3.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token24, i32 1, i32 1) ; (%node3, %node3)
  store ptr addrspace(1) %node_live4.relocated, ptr %node, align 8
  %to_i646 = ptrtoint ptr addrspace(1) %car525 to i64
  %node_live7 = load ptr addrspace(1), ptr %node, align 8
  %statepoint_token26 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @item_check, i32 1, i32 0, i64 %to_i646, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %node_live7) ]
  %call27 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token26)
  %node_live7.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token26, i32 0, i32 0) ; (%node_live7, %node_live7)
  store ptr addrspace(1) %node_live7.relocated, ptr %node, align 8
  ...
  %statepoint_token28 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(ptr addrspace(1) (ptr addrspace(1))) @rt_cdr, i32 1, i32 0, ptr addrspace(1) %node10, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %node_live11, ptr addrspace(1) %node10) ]
  %cdr29 = call ptr addrspace(1) @llvm.experimental.gc.result.p1(token %statepoint_token28)
  %node_live11.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token28, i32 0, i32 0) ; (%node_live11, %node_live11)
  %node10.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token28, i32 1, i32 1) ; (%node10, %node10)
  store ptr addrspace(1) %node_live11.relocated, ptr %node, align 8
  %to_i6412 = ptrtoint ptr addrspace(1) %cdr29 to i64
  %node_live13 = load ptr addrspace(1), ptr %node, align 8
  %statepoint_token30 = call token (i64, i32, ptr, i32, i32, ...) @llvm.experimental.gc.statepoint.p0(i64 2882400000, i32 0, ptr elementtype(i64 (i64)) @item_check, i32 1, i32 0, i64 %to_i6412, i32 0, i32 0) [ "gc-live"(ptr addrspace(1) %node_live13) ]
  %call1431 = call i64 @llvm.experimental.gc.result.i64(token %statepoint_token30)
  %node_live13.relocated = call coldcc ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token %statepoint_token30, i32 0, i32 0) ; (%node_live13, %node_live13)
  store ptr addrspace(1) %node_live13.relocated, ptr %node, align 8
...
declare i64 @llvm.experimental.gc.result.i64(token) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token, i32 immarg, i32 immarg) #1

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare ptr addrspace(1) @llvm.experimental.gc.result.p1(token) #1
